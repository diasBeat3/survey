...
export class Result extends React.Component {
  ...
  showResultRadio = () => {
    return <div>
      <div className="col-sm-12 radio-background">
...
<div className="col-sm-12 radio-background-mobile">
  <div className="sabe-mais-mobile-wrapper">
    <a className="btn-sabe-mais-wrapper-mobile link-style-mobile" href="https://www.facebook.com/RUC107.9FM/">sabe mais aqui</a>
    <a className="bar-result-mobile" href="https://www.facebook.com/RUC107.9FM/"></a>
  </div>
</div>
</div>
  }
  ...
  showResultHumana = () => {
    return <div>
      <div className="col-sm-12 humana-background">
        <div className="title-quest-wrapper">
          <div className="bar-title-wrapper">
        ...
        <div className="title-quest-wrapper-mobile">
          <div className="bar-title-wrapper-mobile">
            <div className="col-sm-6 black-bar-humana-mobile"></div>
            <div className="col-sm-6">
              <div className="title-result-humana title-align-left">secção de defesa<br></br>dos direitos<br></br>humanos</div>
            </div>
          </div>
      ...
      <div className="col-sm-12 humana-background-mobile">
        <div className="sabe-mais-mobile-wrapper">
          <a className="btn-sabe-mais-wrapper-mobile link-style-mobile" href="https://www.facebook.com/sddhaac/">sabe mais aqui</a>
          <a className="bar-result-mobile" href="https://www.facebook.com/sddhaac/"></a>
        </div>
      </div>
    </div>
  }
  ...
  showResultTeatro = () => {
    return <div> 
    <div className="col-sm-12 teatro-background">
      <div className="title-quest-wrapper">
        <div className="bar-title-wrapper">
...
<div className="col-sm-12 teatro-background-mobile">
<div className="sabe-mais-mobile-wrapper">
  <a className="btn-sabe-mais-wrapper-mobile link-style-mobile" href="https://www.facebook.com/citacteatro/">sabe mais aqui</a>
  <a className="bar-result-mobile" href="https://www.facebook.com/citacteatro/"></a>
</div>
</div>
</div>
  }
  ...
  showResultJorna = () => {
    return <div>
      <div className="col-sm-12 jorna-background">
      <div className="title-quest-wrapper">
        <div className="bar-title-wrapper">
          <div className="col-sm-5 black-bar-teatro"></div>
          <div className="col-sm-7">
      ...
      <div className="col-sm-12 jorna-background-mobile">
        <div className="sabe-mais-mobile-wrapper">
          <a className="btn-sabe-mais-wrapper-mobile link-style-mobile" href="https://www.facebook.com/jornalacabra/">sabe mais aqui</a>
          <a className="bar-result-mobile" href="https://www.facebook.com/jornalacabra/"></a>
        </div>
      </div>
    </div>
  }
